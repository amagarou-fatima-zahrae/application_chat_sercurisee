        ...
        <div class="row">
          <div class="col span_1_of_2">
            <div class="hero-description">
              ...
              <a href="UserI" class="btn"
                ><span class="download-btn" > Register Now</span></a
              >
            </div>
          </div>
          <div class="col span_1_of_2">
        ...
        <div class="col span_1_of_2">
          <div class="section-description features-description col1">
            ...
            <p class="little-description">
              you can quickly and conveniently communicate with others 
              without the hassle of phone calls or lengthy emails.
               Whether you need to send a quick message or have a full conversation,
                ChatApp  allows you to do so in just a few seconds. It's the perfect
                 way to stay in touch with friends, family, and colleagues on the go. 
                 So why wait? 
              Start messaging today and simplify your communication!
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="col span_1_of_3 first-col">
          <div class="first-item">
            <div class="item-description">
              ...
              <p>
                Initiating a chat or messaging session with 
                one or more users through a chat application
          ...
          <div class="first-item">
            <div class="item-description">
              ...
              <p>
                Using a communication tool to place a voice call without incurring any charges beyond the cost of internet access.
        ...
        <div class="col span_1_of_3 third-col">
          <div class="last-item">
            ...
            <div class="item-description">
              ...
              <p>
                 Using a camera or camera-equipped device to capture an image 
                that can be saved and shared with others
          ...
          <div class="last-item">
            ...
            <div class="item-description">
              ...
              <p>
                Using a camera or camera-equipped device to capture an 
               image that can be saved and shared with others
