...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 <%@page import= "java.sql.ResultSet" %>
    <%@page import= "com.octest.inscription.inscription" %>
...
@media only screen and (max-width: 480px) {
 ...
 <!--  <form action="UserI" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="etat">Etat familial</label>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="review" name="review" rows="3" placeholder="Ecrire votre reclamation"></textarea>
            </div>
  ...
  <body>
	...
	<div class="login-box">
        <h2 style="font:20px;">Inscription</h2>
	...
	<form action="UserI" method="post" enctype="multipart/form-data">
            ...
            <div class="user-box">
                ...
                <label  for="pwd">Etat familial</label>
            </div>
            <div class="user-box">
            <label  for="pwd">Description</label> <br><br>
              <textarea id="review" name="review" rows="3" ligne="8"></textarea>
                
            </div>
            <button name="login_btn" type="submit">Ajouter</button>
