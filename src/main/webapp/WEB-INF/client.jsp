...
<body>
	...
	<button onclick="send()" id="btn" disabled>send Message</button>
...
<a href="ToPage">Passer à la page HTTP</a>
<p id="id">${id}</p>	
<script>
		let id=document.getElementById("id").textContent;
		let socket = new WebSocket("ws://localhost:8082/chatApp/ServEndpoint?userID="+id);
